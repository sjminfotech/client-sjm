    ...
    <div className="container">
      <div className="about-section">
        <div className="about-text">
          ...
          <h1>
            Helping businesses <span className="highlighted-text">succeed</span>{" "}
            through the power of INFORMATION TECHNOLOGY.
          </h1>
          <p>
            SJM Infotech is a creative and growth-driven IT company committed to
            empowering businesses with modern digital solutions. We specialize
            in Website Designing, App Development, Graphic Designing, and
            Digital Marketing Services — all tailored to help you stand out and
            grow faster in today’s competitive world. Founded by a passionate
            team of tech enthusiasts and strategists, SJM Infotech blends
            innovation with functionality, delivering powerful digital
            experiences that are smart, scalable, and stunning. Video is the
            future of business in this digital-focused world. Vidyard uses video
            to change the way companies connect and communicate. We help
        ...
        <div className="about-image">
          <div
            className="image-shape-wrapper"
            aria-label="A young woman working on a laptop in a creative office with colorful wall art behind her"
          >
            <img
              src={CEO}
              alt="CEO of SJM Infotech"
      ...
      <div className="team-grid">
          ...
          <div className="photo-wrapper">
            <img
              ...
              onError={(e) => {
                ...
                e.target.src =
                  "https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/9485b140-4110-4616-80ea-880a951eea34.png";
              }}
            />
          </div>
        ...
        <div className="team-card">
          <div className="photo-wrapper">
            <img
              src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/7b20e464-83d7-48c7-851c-74c0bd24b55e.png"
              alt="Portrait of William Hill"
              onError={(e) => {
                e.target.onerror = null;
        ...
        <div className="team-card">
          ...
          <div className="social-links">
            ...
            <a href="#" title="Behance">
              <svg className="social-icon" viewBox="0 0 24 24">
                <path d="M22 9.14a7.9 7.9 0 01-2.43.68 7.76 7.76 0 011.47 4.23 7.87 7.87 0 01-7.86 7.86A7.96 7.96 0 014 14.5v-1a7.9 7.9 0 012.33-5.9 7.76 7.76 0 012.57-1.76 7.85 7.85 0 0110.35 2.3zm-2.44 1.52h-1.7v-4.47h1.7a4.72 4.72 0 000-4.47zm-5.38-1.34a2.42 2.42 0 00-2.44 2.44 2.4 2.4 0 001.68 2.31 2.43 2.43 0 01-1.22.32H6.37v-7h5.81a2.42 2.42 0 011.73.93 2.4 2.4 0 01.67 1.59 2.43 2.43 0 01-2.3 2.43zm-2.28-1.47v3.09h2.15a1.43 1.43 0 100-3.09z" />
              </svg>
            </a>
          </div>
        </div>
    ...
    Discover More
      ...
      <div className="features-section">
        <div className="features-image">
          <img
            src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/53060b5e-d310-4826-b44b-79de3f49ef25.png"
            alt="Team collaborating"
            style={{
              maxWidth: "100%",
              height: "auto",
              borderRadius: "12px",
              boxShadow: "0 2px 8px rgba(47,64,102,0.07)",
            }}
            onError={(e) => {
        ...
        <div className="features-content">
          ...
          <p style={{ color: "#fffafa", marginBottom: "2rem" }}>
            We offer you development, installation of complete software systems
            with excellent functionality, performance, and availability.
          </p>
              ...
              <div className="icon-wrapper">
                ...
                >
                  <path
                    ...
                    strokeLinecap="round"
                    strokeWidth="2"
                    d="M12 8c-1.104 0-2 .896-2 2v3a1 1 0 11-2 0v-3a4 4 0 118 0v3a1 1 0 11-2 0v-3c0-1.104-.896-2-2-2z"
                  />
                  <path
                    strokeLinejoin="round"
                    strokeLinecap="round"
              ...
              <div className="icon-wrapper">
                ...
                >
                  <path
                    ...
                    strokeLinecap="round"
                    strokeWidth="2"
                    d="M14 9l3 3m0 0l-3 3m3-3H9"
                  />
                  <path
                    strokeLinejoin="round"
                    strokeLinecap="round"
                    strokeWidth="2"
                    d="M7 18a8 8 0 1111-11"
                  />
                </svg>
              </div>
              <p>Trusted by Many</p>
